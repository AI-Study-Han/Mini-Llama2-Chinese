...
这个项目后面打算暂停更新了。因为之前的代码不太规范，所以新开了一个项目[Zero-Chatgpt](https://github.com/AI-Study-Han/Zero-Chatgpt)代码更规范，并且模型代码兼容huggingface，后续进行其它的开发更方便。这个新的项目也加入了强化学习（rlhf，ppo）的代码，欢迎大家关注新的项目。  
